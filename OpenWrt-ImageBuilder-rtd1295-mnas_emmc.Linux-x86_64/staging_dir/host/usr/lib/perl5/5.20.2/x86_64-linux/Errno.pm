...
"x86_64-linux-4.2.0-27-generic" or
	die "Errno architecture (x86_64-linux-4.2.0-27-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
