...
enum opt_code
{
  ...
  OPT_fhonour_copts = 651,                   /* -fhonour-copts */
  ...
  OPT_mabi_ = 1070,                          /* -mabi= */
  OPT_march_ = 1071,                         /* -march= */
  OPT_mbig_endian = 1072,                    /* -mbig-endian */
  OPT_mbionic = 1073,                        /* -mbionic */
  OPT_mcmodel_ = 1074,                       /* -mcmodel= */
  OPT_mcpu_ = 1075,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1076,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1077,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1078,             /* -mgeneral-regs-only */
  OPT_mglibc = 1079,                         /* -mglibc */
  OPT_mlittle_endian = 1080,                 /* -mlittle-endian */
  OPT_mlra = 1081,                           /* -mlra */
  OPT_mmusl = 1082,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1083,       /* -momit-leaf-frame-pointer */
  OPT_mstrict_align = 1084,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1085,                  /* -mtls-dialect= */
  OPT_mtune_ = 1086,                         /* -mtune= */
  OPT_muclibc = 1087,                        /* -muclibc */
  OPT_n = 1088,                              /* -n */
  ...
  OPT_static_liblsan = 1137,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1138,               /* -static-libstdc++ */
  OPT_static_libtsan = 1139,                 /* -static-libtsan */
  OPT_static_libubsan = 1140,                /* -static-libubsan */
  /* OPT_std_c__03 = 1141, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1142, */                /* -std=c++0x */
  OPT_std_c__11 = 1143,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1144, */                /* -std=c++14 */
  OPT_std_c__1y = 1145,                      /* -std=c++1y */
  OPT_std_c__98 = 1146,                      /* -std=c++98 */
  OPT_std_c11 = 1147,                        /* -std=c11 */
  /* OPT_std_c1x = 1148, */                  /* -std=c1x */
  /* OPT_std_c89 = 1149, */                  /* -std=c89 */
  OPT_std_c90 = 1150,                        /* -std=c90 */
  OPT_std_c99 = 1151,                        /* -std=c99 */
  /* OPT_std_c9x = 1152, */                  /* -std=c9x */
  OPT_std_f2003 = 1153,                      /* -std=f2003 */
  OPT_std_f2008 = 1154,                      /* -std=f2008 */
  OPT_std_f2008ts = 1155,                    /* -std=f2008ts */
  OPT_std_f95 = 1156,                        /* -std=f95 */
  OPT_std_gnu = 1157,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1158, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1159, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1160,                    /* -std=gnu++11 */
  /* OPT_std_gnu__14 = 1161, */              /* -std=gnu++14 */
  OPT_std_gnu__1y = 1162,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1163,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1164,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1165, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1166, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1167,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1168,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1169, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1170, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1171,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1172, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1173, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1174, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1175,                     /* -std=legacy */
  OPT_symbolic = 1176,                       /* -symbolic */
  OPT_t = 1177,                              /* -t */
  OPT_time = 1178,                           /* -time */
  OPT_time_ = 1179,                          /* -time= */
