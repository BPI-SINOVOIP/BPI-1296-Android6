...
static const unsigned int cpu_regulator_latency = 40000;
...
static int realtek_129x_cpufreq_driver_init(struct cpufreq_policy *policy)
{
     ...
     *  
     * transition_latency is from
     *   1. scpu_pll
     *       30 ~ 200
     *       10 ~ 25  when enlarge slop
     *   2. regulator (up to 40)
     */
