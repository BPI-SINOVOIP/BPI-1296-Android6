...
void MCP_AES_128_ECB_DataEncryptTest(void)
{
    ...
    data_dma_vaddr = (unsigned long)dma_alloc_coherent(NULL,
			            sizeof(Data), &data_dma_phyaddr, GFP_ATOMIC);
    ...
    dma_free_coherent(NULL, sizeof(Data), (void *)data_dma_vaddr, data_dma_phyaddr);
}
