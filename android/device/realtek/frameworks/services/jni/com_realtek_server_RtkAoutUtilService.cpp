...
namespace android {
    ...
    static void realtek_server_RtkAoutUtilService_setAudioI2SDelay(JNIEnv *env, jobject obj, jint delay) {
        ALOGD("enter realtek_server_RtkAoutUtilService_setAudioI2SDelay(), delay = %d\n", delay);
        UNUSED(env);
        UNUSED(obj);
        SetAudioI2SDelay(delay);
    }
    ...
    static const JNINativeMethod RtkAoutUtilServiceMethods[] = {
        ...
        {"_setAudioI2SDelay", "(I)V", (void*) realtek_server_RtkAoutUtilService_setAudioI2SDelay },
