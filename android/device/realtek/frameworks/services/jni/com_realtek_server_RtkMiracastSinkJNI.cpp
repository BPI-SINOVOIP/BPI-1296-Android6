...
static jint realtek_server_RtkMiracastSink_open(JNIEnv *env, jobject thiz, jstring clientPackageName)
{
...
static void realtek_server_RtkMiracastSink_close(JNIEnv *env, jobject thiz)
{
    ALOGV(TAG "RtkMiracastSink_close");
    //player = 0;
}

static void realtek_server_RtkMiracastSink_setDisplay(JNIEnv *env, jobject thiz, jobject jSurface)
{
...
static void realtek_server_RtkMiracastSink_SetParameters(JNIEnv *env, jobject thiz,jint left, jint top,jint width, jint height,jint show)
{	
...
static jint realtek_server_RtkMiracastSink_GetReady(JNIEnv *env, jobject thiz)
{
	int ret = 0;
	int retry = 0;
...
static void realtek_server_RtkMiracastSink_SetUIBC(JNIEnv *env, jobject thiz,jint on)
{	
...
static jint realtek_server_RtkMiracastSink_start(JNIEnv *env, jobject thiz,jstring ip, jint port)
{
...
static jint realtek_server_RtkMiracastSink_stop(JNIEnv *env, jobject thiz)
{
...
static const JNINativeMethod sMethods[] = {
    {"jni_wfd_sink_Open", "(Ljava/lang/String;)I", (void*) realtek_server_RtkMiracastSink_open },
    {"jni_wfd_sink_Close", "()V", (void*) realtek_server_RtkMiracastSink_close },
    {"jni_wfd_sink_SetDisplay", "(Landroid/view/Surface;)V", (void*) realtek_server_RtkMiracastSink_setDisplay },
    {"jni_wfd_sink_SetParameters", "(IIIII)V", (void*) realtek_server_RtkMiracastSink_SetParameters },
    {"jni_wfd_sink_GetReady", "()I", (void*) realtek_server_RtkMiracastSink_GetReady },
    {"jni_wfd_sink_SetUIBC", "(I)V", (void*) realtek_server_RtkMiracastSink_SetUIBC },
    {"jni_wfd_sink_Start", "(Ljava/lang/String;I)I", (void*) realtek_server_RtkMiracastSink_start },
    {"jni_wfd_sink_Stop", "()I", (void*) realtek_server_RtkMiracastSink_stop },    
};
...
int register_realtek_server_RtkMiracastSink(JNIEnv *env) {
	//ALOGI("[%s][%s][%d], euid=%d\n", __FILE__, __func__, __LINE__,geteuid());	
	jclass clazz = env->FindClass("com/realtek/server/RTKMiracastSinkJNI");
    if (clazz == NULL)
	{
		ALOGE("Can't find com/realtek/server/RTKMiracastSinkJNI");
		return -1;
	}
    return jniRegisterNativeMethods(env, "com/realtek/server/RTKMiracastSinkJNI",sMethods, NELEM(sMethods));        
}
} /* namespace android */
