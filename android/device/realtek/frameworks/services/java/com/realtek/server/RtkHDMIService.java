...
public class RtkHDMIService extends IRtkHDMIService.Stub {
	...
	public RtkHDMIService(Context context) {
        ...
        hdmiFilter.addAction("rtk.intent.action.reloadTVSystem");
        hdmiFilter.addAction("rtk.intent.action.ALL_ON_NOW");
        hdmiFilter.addAction("rtk.intent.action.ALL_OFF_NOW");
	...
	private BroadcastReceiver hdmiHotPlugReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
            ...
            else if(action.equals("rtk.intent.action.reloadTVSystem")){
                Slog.w(TAG, "receive rtk.intent.action.reloadTVSystem");
                reloadTVSystem();
                return;
            }
            else if(action.equals("rtk.intent.action.ALL_ON_NOW")) {
                reloadTVSystem();
                return;
            }
            else if(action.equals("rtk.intent.action.ALL_OFF_NOW")) {
                turnOffDPExt();
                turnOffHdmi();
                return;
            }
