...
public class RtkTVSystem implements Parcelable {
	...
	// TV setting menu
	public static final int TV_SYS_DP_AUTO_DETECT = 0;
	public static final int TV_SYS_DP_720P_60HZ = 1;
	public static final int TV_SYS_DP_1080P_60HZ = 2;
	public static final int TV_SYS_DP_2160P_30HZ = 3;
	public static final int TV_SYS_DP_NUM = 4;
	...
	public static final int VIDEO_DP_720P_60HZ = 28;
	public static final int VIDEO_SYSTEM_NUM = 29; // VIDEO_SYSTEM_NUM should be the last.
