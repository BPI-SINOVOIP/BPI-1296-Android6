...
*/
    ...
    private native void _setHDMICVBSDisplayRatio(int ratio);
    private native void _setDPDisplayRatio(int ratio);
    private native void _SetDPDisplayXYOffset(int x, int y);
	
	private native void _setDPDisplayBCHSSetting(int brightness, int contrast, int hue, int saturation);
    private native void _setHDROff(int hdr_off);
