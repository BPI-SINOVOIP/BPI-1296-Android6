...
private:
    ...
    void CheckToFreeSequenceChangeBuffer(int checkPLock);
    int GetErrorCntDown();
...
#endif
    int VDecScanPLockBufferClearRtkFlag(int *pNumLock=NULL, int *pNumQpend=NULL, int *pNumClrDispFlag=NULL);
    ...
    void ParseH264UserData(BYTE* pUserDataBuf);
...
#endif
    int mIonFd;
    unsigned int mTotAllocIonSizeOfFb;
