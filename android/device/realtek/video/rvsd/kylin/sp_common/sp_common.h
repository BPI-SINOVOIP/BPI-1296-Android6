...
#define SP_ION_SEG_NUM 2
#define SP_ION_FILTER_IDX 0
#define SP_ION_DECODER_IDX 1
...
#define SP_SLEEP() usleep(30000)   // estimate 30ms ... Need to tune...
...
#define ION_DVB_SIZE (4 * 1024 * 1024)
#define ION_BD_SIZE (10 * 1024 * 1024)
...
#define VMM_SIZE_BD_SUBTITLE 0x0600000
