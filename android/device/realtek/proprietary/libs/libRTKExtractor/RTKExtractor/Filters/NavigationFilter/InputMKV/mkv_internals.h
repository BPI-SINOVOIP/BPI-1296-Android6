...
inline UINT mkvGetFilePos(InputMKV_t *pMKV);
inline void mkvSkip(InputMKV_t *pMKV, UINT len);
inline int mkvSeekTo(InputMKV_t *pMKV, UINT pos);
inline char mkvReadByte(InputMKV_t *pMKV, char *charOut);
inline char mkvReadBytes(InputMKV_t *pMKV, void *buffer, int len);
char mkvReadVUINT(InputMKV_t *pMKV, UINT *retInteger, int *len);
inline char mkvReadVINT(InputMKV_t *pMKV, INT *retInteger);
inline char mkvReadUINT(InputMKV_t *pMKV, UINT *retInteger, unsigned int len);
inline char mkvReadINT(InputMKV_t *pMKV, INT *retInteger, unsigned int len);
char mkvReadFloat(InputMKV_t *pMKV, FLOAT *pFloat, unsigned int len);
inline char mkvReadSize(InputMKV_t *pMKV, UINT *retSize);
