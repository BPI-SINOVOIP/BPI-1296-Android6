...
#define AMESSAGE_CAP_MODE			 "capMode"
#define ABUFFER_QUEUE_BUFFER_FOR_USER  "queueBufForUser"
#define ABUFFER_DEQUE_BUFFER_FOR_USER  "dequeBufForUser"
#define AMESSAGE_AUDIO_STREAM_TYPE   "type"
