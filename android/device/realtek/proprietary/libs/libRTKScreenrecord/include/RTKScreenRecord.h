...
public:
    ...
    virtual void            SetBufferProtect(bool is422);
...
public:
    enum{
        ...
        SCREEN_RECORD_PROTECT_ALWAYS_CHECK  = 0x1U << 4,
    };
    ...
    static void PreConfigCheck(int writebackType, uint32_t * pUsage, int * pWidth, int * pHeight);
