				    ...
				    void *ctx)
{
	...
	//fix bug 41768 by borg 2014/04/17:
	//Delay 200ms to prevent WPA connection collide with WPS disconnetion
	//of receiving DeAuth.
	// success: Auth Success
	// wpa_s->wps_success: WPS Success
	if(result != EAPOL_SUPP_RESULT_SUCCESS && wpa_s->wps_success)
	{
		os_sleep(0, 200000);
	}
