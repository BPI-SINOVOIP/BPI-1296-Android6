...
#./rtwpriv wlan0 [Channel] [Bandwidth] [ANT_PAH] [RateID] [TxMode]
./rtwpriv wlan0 36 0 1 a MCS0 1 

Instruction Command format:
		#####[ HW TX mode ] VHT IC Suppport Only#####
	 Input the parameters like this:rtwpriv wlan0 [Channel] [Bandwidth] [ANT_PAH] [RateID] [TxMode]
	[Channel]: 1~167
