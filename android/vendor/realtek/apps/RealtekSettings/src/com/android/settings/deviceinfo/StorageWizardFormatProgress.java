...
public class StorageWizardFormatProgress extends StorageWizardBase {
    ...
    public static class PartitionTask extends AsyncTask<Void, Integer, Exception> {
        ...
        protected Exception doInBackground(Void... params) {
            ...
            if ((SystemProperties.get("persist.rtk.net.openwrt", "false").equals("true"))){
                String targetDisk = activity.mDisk.sysPath.substring(activity.mDisk.sysPath.lastIndexOf("/"));
               // UbusRpc ubusRpc = null;
                publishProgress(40);
               // if (ubusRpc == null) {
                   // ubusRpc = new UbusRpc();
               // }
               // String json = "\"disk-helper\", \"allinone\" , {\"devname\": \""+targetDisk+"\", \"fstype\": \"fat32\"}";
               // try{
                   // publishProgress(60);
                   // String ret = ubusRpc.post(json);
                   // publishProgress(80);
