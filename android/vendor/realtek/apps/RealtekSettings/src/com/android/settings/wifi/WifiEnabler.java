...
public class WifiEnabler implements SwitchBar.OnSwitchChangeListener  {
    ...
    // native / toggle
    private static final String RTK_WIFI_SWITCH_PROFILE = "persist.rtk.wifi.switchProfile";
    ...
    public void onSwitchChanged(Switch switchView, boolean isChecked) {
        ...
        int wifiState = mWifiManager.getWifiState(); // [realtek]
        String switchProfile = SystemProperties.get(RTK_WIFI_SWITCH_PROFILE, "native");

        mWifiManager.setSoftApMode(!isChecked); // [realtek] set softAp mode state.        
        if (isChecked && ((wifiApState == WifiManager.WIFI_AP_STATE_ENABLING) ||
                        (wifiApState == WifiManager.WIFI_AP_STATE_NEED_START) || // [realtek] check if need restart soft AP
        ...
        // [realtek] : if switchProfile is toggle, need to enable SoftAp & tethering if disable Wifi
        if( switchProfile.equals("toggle") && !isChecked) {
