...
public class TetherSettings extends SettingsPreferenceFragment
    ...
    private void initWifiTethering() {
        ...
        if (mWifiConfig == null) {
            ...
            // [realtek] SoftAP/ DLNA/ Device Name are the same, refs to : Settings.Global.DEVICE_NAME
            final String s = Settings.Global.getString(getContentResolver(), Settings.Global.DEVICE_NAME);
