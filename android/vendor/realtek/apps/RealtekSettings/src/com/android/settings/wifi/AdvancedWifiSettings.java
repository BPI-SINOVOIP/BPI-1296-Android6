...
public class AdvancedWifiSettings extends SettingsPreferenceFragment
    ...
    private WpsFragment mWpsFragment;
    ...
    public void onPause() {
        super.onPause();
        if(mWpsFragment!=null){
            mWpsFragment.dismiss();
        }
    ...
    private void initPreferences() {
        ...
        wpsPushPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                public boolean onPreferenceClick(Preference arg0) {
                    mWpsFragment = new WpsFragment(WpsInfo.PBC);
                    mWpsFragment.show(getFragmentManager(), KEY_WPS_PUSH);
                    return true;
                }
        });
        ...
        wpsPinPref.setOnPreferenceClickListener(new OnPreferenceClickListener(){
                public boolean onPreferenceClick(Preference arg0) {
                    mWpsFragment = new WpsFragment(WpsInfo.DISPLAY);
                    mWpsFragment.show(getFragmentManager(), KEY_WPS_PIN);
                    return true;
                }
        });
