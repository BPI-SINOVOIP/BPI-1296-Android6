...
public class DevelopmentSettings extends SettingsPreferenceFragment
    ...
    private void writeHdmiDpDiffSource() {
        mRebootDialog = new AlertDialog.Builder(getActivity())
                ...
                .setPositiveButton(R.string.hdmi_dp_reboot_button,
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (mHdmiDpDiffSource.isChecked()) {
                                    mCVBSZoomIn.setEnabled(true);
                                    mHDMICVBSZoomIn.setEnabled(true);
                                } else {
                                    mCVBSZoomIn.setEnabled(false);
                                    mHDMICVBSZoomIn.setEnabled(false);
                ...
                //.setNegativeButton(android.R.string.cancel, null)
                .create();
        mRebootDialog.setOnCancelListener(new OnCancelListener() {
            @Override
            public void onCancel(DialogInterface dialog) {
                Log.d(TAG, "Reboot dialog has been cancel.");
                updateHdmiDpDiffSource();
            }
        });
        mRebootDialog.show();
    ...
    private void writeHdrOnOffMode() {
        ...
        // reload tv system to apply new setting
        mRtkHDMIManager.reloadTVSystem();
    }
