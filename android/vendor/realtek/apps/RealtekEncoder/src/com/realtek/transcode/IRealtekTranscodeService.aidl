...
interface IRealtekTranscodeService {
	...
	void setDataSource(int idx, String source, String target, String output, int track);
    ...
    // iFrame : I frame interval ex. 10, 24, 30, ...
	...
	void setVideoParameter(int idx, String resolution, String frameRate, int bitRate, int iFrame, 
