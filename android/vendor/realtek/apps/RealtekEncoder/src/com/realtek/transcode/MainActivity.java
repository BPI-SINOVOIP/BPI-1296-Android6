...
public class MainActivity extends Activity implements OnClickListener {
    ...
    private static final int ENCODER_PARAMETER_SET = 3;
    ...
    private String[] FrameInterval = {"10", "24", "30", "60"};
    ...
    private String[] Resol = {"Original", "4K", "1080P", "720P"};
...
//    }
    ...
    public void onClick(View v) {
        if(v instanceof AutoCompleteTextView){
            ...
            intent.putExtra("RESOLUTION", selectedResol);
