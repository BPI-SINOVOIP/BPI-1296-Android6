...
public final class Transcode {
    ...
    private String mVideoResolution = "Original";
    ...
    private int run(String[] args) throws IOException, RemoteException {
        ...
        mManager.setDataSource(mInputFile, mOutputFile, mOutputFormat, mOutputTracks);
        mManager.setVideoParameter(mVideoResolution, mVideoFrameRate, mVideoBitrate, mVideoFrameInterval, mDeinterlace, mBitrateMode, mProfile, mLevel);
    ...
    private static int showUsage() {
        System.err.println("usage: transcode [-o src] [-d dst] [-m muxer] [-t track] [-r resolution] [-f fps] [-b bitrate] [-i interval] [-a deinterlace] [-e bitrate mode] [-p profile] [-l level] [-s samplerate] [-c channel] [-k kill]");
        System.err.println("    -o src: input file");
        System.err.println("    -d dst: output file");
        System.err.println("    -m muxer: MPEG2TS / MP4");
        System.err.println("    -t tracks: 0:VideoOnly 1:AudioOnly 2:Audio+Video");
        System.err.println("    -r resolution: Original / 4K / 1080P / 720P");
