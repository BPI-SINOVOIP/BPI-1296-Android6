...
public class SuspendHandler extends BroadcastReceiver {
    ...
    */
    ...
    private boolean tryEnableBluetooth(boolean enable) {
        ...
        if (bluetoothAdapter == null) {
            ...
            if(!enable){
                if (bluetoothAdapter.isEnabled()) {
                    // Bluetooth is enable, save status and stop it.
                    Slog.d(TAG, "disable bluetooth");
                    mBluetoothIsOn = true;
                    bluetoothAdapter.disable();
                    return true;
                }
            } else if(mBluetoothIsOn) {
                Slog.d(TAG, "enable bluetooth");
                bluetoothAdapter.enable();
                mBluetoothIsOn = false;
                return true;
            }
        }
        return false;
