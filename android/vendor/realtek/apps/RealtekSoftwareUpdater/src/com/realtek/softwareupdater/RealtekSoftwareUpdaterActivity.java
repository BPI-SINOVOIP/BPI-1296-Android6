...
public class RealtekSoftwareUpdaterActivity extends Activity implements OnScrollListener {
    ...
    private static final String mOTAXMLUrl = "http://172.21.98.109/appliance.xml";  // xml link on server side.
    ...
    private class ListViewItemClickListener implements OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            try {
                ...
                if(mSoftwareFilesInFullPath.get(position).getType() != RECOVERY_SOFTWARE_TYPE_OTA) {  //  OTA path we will reboot once the downloading is done.
