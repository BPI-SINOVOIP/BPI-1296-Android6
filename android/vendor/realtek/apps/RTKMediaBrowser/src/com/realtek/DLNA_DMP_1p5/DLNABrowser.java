...
public class DLNABrowser {
    ...
    private static long MagicCode=0;
	...
	*/
    ...
    public void SetMagicCode(long code)
    {
        synchronized(lock)
        {
            ...
            Log.d(TAG,"Set MagicCode ="+MagicCode);
        }
    }
    public synchronized void StopPreviousWork()
    {
        Log.d(TAG, "call DLNA_DMP_1p5_stopWatingResponse");
    ...
    {
        if(false==DLNA_DMP_1p5.DLNA_DMP_1p5_UPnPServiceBrowseMetadata(UniqueID)){
            Log.d(TAG,"UPnPServiceBrowse ID["+UniqueID+"] failed");
            return "false";
        }
    ...
    public synchronized String GetItemMediaInfo(String UniqueID, int type)
    {
        ...
        if (mediaInfo == null){
            Log.d(TAG,"[Wrong] Get null info of DLNA UniqueID:"+UniqueID+ " type:"+type);
        }
	    return mediaInfo;
    }
    ...
    public synchronized ArrayList<String> GetSubtitleList(String UniqueCharID)
    {
        ...
        {
            Log.d(TAG,"[Wrong] UniqueCharID is null");
            return null;
        }
    }
