...
//                    mntDataProvider =  new SMBFileDataProvider2 (mSmbPath, mMountPath, mDomain, mUser, mPassword,
    ...
    public static SmbBrowser GetInstance(int fileType, Context context, MimeTypes mimetypes, Handler handler)
	{
...
//        else
	...
	public int SmbQuery(String path)
	{
...
//                mDomain = segments[0];
                ...
                log(mDomain+","+mUser);
                auth = new NtlmPasswordAuthentication(mDomain, mUser, mPassword);
                SmbFile f = null;
                try {
