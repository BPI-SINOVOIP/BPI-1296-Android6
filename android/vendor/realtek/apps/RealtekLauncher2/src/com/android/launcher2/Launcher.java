...
public final class Launcher extends Activity
    ...
    */
	...
	Log.i(TAG, "onResume mOnResumeState:"+mOnResumeState+" mState:"+mState);
        ...
        updateGlobalIcons();
        sendRtkAdvMessageToHandler(DRAW_FOCUS_AFTER_ON_RESUME, 100);
...
//        }
    ...
    public void launchSelfWidgetMainActivity(AppWidgetProviderInfo pInfo){
    	...
    	if(label.equals(appWidgetLabel)){
    		...
    		Intent intent=packageManager.getLaunchIntentForPackage(ConstantsDef.SETTING_PKG_NAME);
    		intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
    	 ...
    	 // launch Intel Widi apk
    	    ...
    	    Intent i = new Intent();
    	    ComponentName comp = new ComponentName(ConstantsDef.SETTING_PKG_NAME, "com.android.settings.Settings$StorageSettingsActivity");
    	    i.setComponent(comp);
