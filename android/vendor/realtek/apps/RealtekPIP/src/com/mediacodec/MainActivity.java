...
public class MainActivity extends Activity implements OnClickListener {
    ...
    private CheckBox chbMediaPlayer = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chbMediaPlayer = (CheckBox) findViewById(R.id.chbMediaPlayer);
	...
	spnSource = (Spinner) findViewById(R.id.spnSource);
        ...
        chbMediaPlayer.setChecked(false);
...
//                intent.putExtra("AUDIOCLICK", 0);
            if(chbMediaPlayer.isChecked())
                intent.putExtra("MEDIAPLAYER", 1);
            else
