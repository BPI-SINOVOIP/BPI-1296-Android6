...
public class MovieActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent()!=null && getIntent().getExtras()!=null && getIntent().getExtras().containsKey(USE_RT_MEDIAPLAYER_EXTRA)==true) {
            if(getIntent().getExtras().getBoolean(USE_RT_MEDIAPLAYER_EXTRA)==true) {
                ...
                SystemProperties.set("rtk.media.playback.acceleration", Long.toString(1));
            }
            else {
                mUseRTMediaPlayer = MediaPlayer.FORCE_ANDROID_MEDIAPLAYER;
                SystemProperties.set("rtk.media.playback.acceleration", Long.toString(0));
            }
        }
        else {
        ...
        if(getIntent()!=null && getIntent().getExtras()!=null && getIntent().getExtras().containsKey("PackageName")==true) {
    ...
    public boolean optionMenuHandler(String item, int position) {
        ...
        if (item.equals("Subtitle")){
            ...
            for (int i = 0; i < mSubMenuGroup.length; i++) {
                mSubMenuGroup[i].Show( (i == mCurrentSubFocus) );
            }
            ...
            mStringUpkey.showAtLocation(mStringUpView, Gravity.LEFT| Gravity.TOP, mSubMenuGroup[mCurrentSubFocus].m_x,
                (int)getResources().getDimension(R.dimen.video_subtitle_menu_y) - (int)getResources().getDimension(R.dimen.video_subtitle_updown_key_height));
            mStringDownkey.showAtLocation(mStringDownView, Gravity.LEFT| Gravity.TOP, mSubMenuGroup[mCurrentSubFocus].m_x,
                (int)getResources().getDimension(R.dimen.video_subtitle_menu_y) + (int)getResources().getDimension(R.dimen.video_subtitle_menu_height));
    ...
    private void NewSubtitleMenu() {
        ...
        int x = (int)getResources().getDimension(R.dimen.video_subtitle_menu_x);
        mSubMainMenu= new RTKVScrollMenu(x,
            (int)getResources().getDimension(R.dimen.video_subtitle_menu_y),
            (int)getResources().getDimension(R.dimen.video_subtitle_menu_width_1),
            (int)getResources().getDimension(R.dimen.video_subtitle_menu_height),
        ...
        x += (int)getResources().getDimension(R.dimen.video_subtitle_menu_width_1);
        mSubOffsetMenu= new RTKVScrollMenu(x,
            (int)getResources().getDimension(R.dimen.video_subtitle_menu_y),
            (int)getResources().getDimension(R.dimen.video_subtitle_menu_width_2),
            (int)getResources().getDimension(R.dimen.video_subtitle_menu_height),
        ...
        ContentView = getLayoutInflater().inflate(R.layout.vscrollmenu_number, null); 
        x += (int)getResources().getDimension(R.dimen.video_subtitle_menu_width_2);
        mSubSizeMenu= new RTKVScrollMenu(x,
            (int)getResources().getDimension(R.dimen.video_subtitle_menu_y),
            (int)getResources().getDimension(R.dimen.video_subtitle_menu_width_2),
            (int)getResources().getDimension(R.dimen.video_subtitle_menu_height),
        ...
        x += (int)getResources().getDimension(R.dimen.video_subtitle_menu_width_2);
        mSubSyncMenu= new RTKVScrollMenu(x,
            (int)getResources().getDimension(R.dimen.video_subtitle_menu_y),
            (int)getResources().getDimension(R.dimen.video_subtitle_menu_width_1),
            (int)getResources().getDimension(R.dimen.video_subtitle_menu_height),
        ...
        x += (int)getResources().getDimension(R.dimen.video_subtitle_menu_width_1);
        mSubEncodeMenu= new RTKVScrollMenu(x,
            (int)getResources().getDimension(R.dimen.video_subtitle_menu_y),
            (int)getResources().getDimension(R.dimen.video_subtitle_menu_width_1),
            (int)getResources().getDimension(R.dimen.video_subtitle_menu_height),
        ...
        ContentView = getLayoutInflater().inflate(R.layout.vscrollmenu, null); 
        x += (int)getResources().getDimension(R.dimen.video_subtitle_menu_width_1);
        mSubColorMenu= new RTKVScrollMenu(x,
            (int)getResources().getDimension(R.dimen.video_subtitle_menu_y),
            (int)getResources().getDimension(R.dimen.video_subtitle_menu_width_2),
            (int)getResources().getDimension(R.dimen.video_subtitle_menu_height),
    ...
    private void NewAudioMenu() {
        View ContentView = getLayoutInflater().inflate(R.layout.vscrollmenu,null);
        mAudioMenu = new RTKVScrollMenu((int)getResources().getDimension(R.dimen.video_audio_menu_x),
            (int)getResources().getDimension(R.dimen.video_audio_menu_y),
    ...
    private void NewBDInfoMenu() {
        View ContentView = getLayoutInflater().inflate(R.layout.vscrollmenu,null);
        mBDInfoMenu = new RTKVScrollMenu((int)getResources().getDimension(R.dimen.video_audio_menu_x),
            (int)getResources().getDimension(R.dimen.video_audio_menu_y),
            (int)getResources().getDimension(R.dimen.video_audio_menu_width),
            (int)getResources().getDimension(R.dimen.video_audio_menu_height),
    ...
    private void NewBDChapterInfoMenu() {
        View ContentView = getLayoutInflater().inflate(R.layout.vscrollmenu,null);
        mBDChapterInfoMenu = new RTKVScrollMenu((int)getResources().getDimension(R.dimen.video_audio_menu_x),
            (int)getResources().getDimension(R.dimen.video_audio_menu_y),
            (int)getResources().getDimension(R.dimen.video_audio_menu_width),
            (int)getResources().getDimension(R.dimen.video_audio_menu_height),
    ...
    private void NewPropertyMenu() {
        ...
        mPropertyMenu = new RTKVScrollMenu((int)getResources().getDimension(R.dimen.property_menu_x),
            (int)getResources().getDimension(R.dimen.property_menu_y),
    ...
    public int getSubtitleIndexPref(String path){
        ...
        if(prefs.contains(path)) {
            subtitleIndex = prefs.getInt(path, 0);
        }
...
//        Log.d(TAG, "prefs.getAll(): " + prefs.getAll());
    ...
    public void setSubtitleIndexPref(String path, int subtitleIndex){
        ...
        if(mPlayer.getSubtitleCount()>0) {
            editor.putInt(path, subtitleIndex);
        }
        ...
        editor.apply();
        Log.d(TAG, "setSubtitleIndexPref: " + subtitleIndex);
    }
