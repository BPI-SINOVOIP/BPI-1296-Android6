...
//        GalleryUtils.cancelPhotoNotification(mActivity);
    ...
    private void NewSlideshowMenu() {
        ...
        mSlideshowMenu = new RTKVScrollMenu((int)mActivity.getResources().getDimension(R.dimen.photo_scroll_menu_x),
            (int)mActivity.getResources().getDimension(R.dimen.photo_scroll_menu_y),
    ...
    private void NewSlideshowTimingMenu() {
        View ContentView = mActivity.getLayoutInflater().inflate(R.layout.vscrollmenu,null);
        mSlideshowTimingMenu = new RTKVScrollMenu((int)mActivity.getResources().getDimension(R.dimen.photo_scroll_menu_x),
            (int)mActivity.getResources().getDimension(R.dimen.photo_scroll_menu_y),
            (int)mActivity.getResources().getDimension(R.dimen.photo_scroll_menu_width),
            (int)mActivity.getResources().getDimension(R.dimen.photo_scroll_menu_height),
    ...
    private void NewBgMusicMenu() {
        View ContentView = mActivity.getLayoutInflater().inflate(R.layout.vscrollmenu,null);
        mBgMusicMenu = new RTKVScrollMenu((int)mActivity.getResources().getDimension(R.dimen.photo_scroll_menu_x),
            (int)mActivity.getResources().getDimension(R.dimen.photo_scroll_menu_y),
            (int)mActivity.getResources().getDimension(R.dimen.photo_scroll_menu_width),
            (int)mActivity.getResources().getDimension(R.dimen.photo_scroll_menu_height),
    ...
    private void NewEXIFMenu() {
        ...
        mEXIFMenu = new RTKVScrollMenu((int)mActivity.getResources().getDimension(R.dimen.photo_exif_menu_x),
            (int)mActivity.getResources().getDimension(R.dimen.photo_exif_menu_y),
            (int)mActivity.getResources().getDimension(R.dimen.photo_exif_menu_width),
            (int)mActivity.getResources().getDimension(R.dimen.photo_exif_menu_height),
    ...
    private void NewRepeatMenu() {
        View ContentView = mActivity.getLayoutInflater().inflate(R.layout.vscrollmenu,null);
        mSlideshowRepeatMenu = new RTKVScrollMenu((int)mActivity.getResources().getDimension(R.dimen.photo_scroll_menu_x),
            (int)mActivity.getResources().getDimension(R.dimen.photo_scroll_menu_y),
            (int)mActivity.getResources().getDimension(R.dimen.photo_scroll_menu_width),
            (int)mActivity.getResources().getDimension(R.dimen.photo_scroll_menu_height),
    ...
    private void NewEffectMenu() {
        View ContentView = mActivity.getLayoutInflater().inflate(R.layout.vscrollmenu,null);
        mSlideshowEffectMenu= new RTKVScrollMenu((int)mActivity.getResources().getDimension(R.dimen.photo_scroll_menu_x),
            (int)mActivity.getResources().getDimension(R.dimen.photo_scroll_menu_y),
            (int)mActivity.getResources().getDimension(R.dimen.photo_scroll_menu_width),
            (int)mActivity.getResources().getDimension(R.dimen.photo_scroll_menu_height),
