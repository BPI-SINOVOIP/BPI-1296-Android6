...
public class MainActivity extends Activity
{
	...
	// get the info from the currently running task
		...
		if((!componentInfo.getPackageName().equals("com.example.RTKMiracastSink")) 
		   || ((1 == SystemProperties.getInt("persist.rtk.screenoff.suspend",0)) && (!componentInfo.flattenToShortString().equals("com.example.RTKMiracastSink/.VideoViewActivity"))))
		//for Home Key case or SCREEN_OFF_SUSPEND_ON mode of PowerManagerService
			StopMiracastService();
	}
