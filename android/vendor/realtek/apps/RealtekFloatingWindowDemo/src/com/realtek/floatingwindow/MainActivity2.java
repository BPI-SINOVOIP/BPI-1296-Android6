...
public class MainActivity2 extends Activity {
    ...
    private SettingWidgets2 mMediaPlayerWidgets2_2;
    private SettingWidgets2 mMediaPlayerWidgets2_3;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        mMediaPlayerWidgets2_2 = (SettingWidgets2) findViewById(R.id.media_player_setting_2_2);
        mMediaPlayerWidgets2_3 = (SettingWidgets2) findViewById(R.id.media_player_setting_2_3);
        ...
        mMediaPlayerWidgets2_2.init();
        mMediaPlayerWidgets2_3.init();
    ...
    class ButtonClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if(!FloatingWindowService2.bServiceIsAlive){
                ...
                Bundle mMPConfig2 = mMediaPlayerWidgets2_2.getSettingConfig();
                Bundle mMPConfig3 = mMediaPlayerWidgets2_3.getSettingConfig();
                ...
                serviceIntent.putExtra("mp2",mMPConfig2);
                serviceIntent.putExtra("mp3",mMPConfig3);
                ...
                mMediaPlayerWidgets2_2.setEnabled(false);
                mMediaPlayerWidgets2_3.setEnabled(false);
            }else{
                // stop service
                ...
                mMediaPlayerWidgets2_2.setEnabled(true);
                mMediaPlayerWidgets2_3.setEnabled(true);
            }
        }
    }
