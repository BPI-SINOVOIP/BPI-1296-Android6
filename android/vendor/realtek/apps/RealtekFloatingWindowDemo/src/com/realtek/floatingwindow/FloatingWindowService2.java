...
public class FloatingWindowService2 extends Service {
    ...
    */
    ...
    class MyReceiver extends BroadcastReceiver {
        ...
        FloatingWindowService2 mService;

        MyReceiver(FloatingWindowService2 service){
            mService = service;
        }
    ...
    private void createFloatingWindowEx2(int winId, Bundle arg){
        ...
        */
        ...
        if(winId == 0){
            ...
            group.wmParams.y = screenHeight/2 - height/2;
        }else{
            group.wmParams.y = 0;
        }
    ...
    */
    ...
    public int onStartCommand (Intent intent, int flags, int startId) {
        ...
        */
        ...
        mMP2 = intent.getBundleExtra("mp2");
        mMP3 = intent.getBundleExtra("mp3");
        ...
        if(mMP != null){
            createFloatingWindowEx2(0,mMP);
        }

        if(mMP2 != null) {
            createFloatingWindowEx2(1,mMP2);
        }

        if(mMP3 != null) {
            createFloatingWindowEx2(2,mMP3);
        }
