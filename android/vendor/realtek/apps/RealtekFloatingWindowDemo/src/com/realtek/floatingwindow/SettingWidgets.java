...
public class SettingWidgets extends LinearLayout {
    ...
    public static final String KEY_AUDIO_CAP    = "audioCapture";
    ...
    private CheckBox mAudioCaptureCheckBox;
    ...
    public void init(boolean recordEn, String token){
        ...
        mAudioCaptureCheckBox = (CheckBox) findViewById(R.id.audio_capture_checkbox);
        ...
        mAudioCaptureCheckBox.setText("Capture audio");
        ...
        if(!bCanRecord){
            ...
            mAudioCaptureCheckBox.setEnabled(false);
        }
    ...
    public void setEnabled(boolean enable){
        ...
        mAudioCaptureCheckBox.setEnabled(enable && bCanRecord);
    ...
    public Bundle getSettingConfig(){
        ...
        boolean audioCap = mAudioCaptureCheckBox.isChecked();
        ...
        bundle.putBoolean(KEY_AUDIO_CAP,audioCap);
