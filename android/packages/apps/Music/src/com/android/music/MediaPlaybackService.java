                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    if (action.equals(Intent.ACTION_MEDIA_EJECT)) {
                        ...
                        if (mSourceFrom == SOURCE_LOCAL) {
                            ...
                            if (mUrlPlayList != null) {
                                currentPath = mFileToPlay;
                            }
                            else if (mIdPlayList != null && mCursor != null){
                                currentPath = mCursor.getString(mCursor.getColumnIndexOrThrow(MediaStore.Audio.Media.DATA));
                            }
                            Log.d(LOGTAG, "registerExternalStorageListener - eject device = " + intent.getData().getPath());
                            Log.d(LOGTAG, "registerExternalStorageListener - currentPath = " + currentPath);
    ...
    public boolean open(String path) {
        ...
        synchronized (this) {
            ...
            if (mCursor == null) {
                ...
                else if (path.toLowerCase().startsWith("file://")) {  //already in database
