...
public class BrowserSettings implements OnSharedPreferenceChangeListener,
    ...
    private void syncSetting(WebSettings settings) {
        ...
        if (ua != null) {
            ...
            settings.setUserAgentString(useragentMap.get(getUserAgentName()));
        }
    }
    ...
    private void initUseragentmap() {
        ...
        useragentMap.put("Nexus_O", FROYO_USERAGENT);
        useragentMap.put("Nexus_S", GINGERBREAD_USERAGENT);
        useragentMap.put("Moto_Xoom", HONEYCOMB_USERAGENT);
    ...
    public void toggleDesktopUseragent(WebView view) {
        ...
        if (mCustomUserAgents.get(settings) != null) {
            ...
            settings.setUserAgentString(useragentMap.get(mUserAgentName));
        } else {
            mCustomUserAgents.put(settings, useragentMap.get(mUserAgentName));
            settings.setUserAgentString(useragentMap.get(mUserAgentName));
        }
    }
