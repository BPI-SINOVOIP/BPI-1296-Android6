...
public class NetworkTemplate implements Parcelable {
    ...
    public static final int MATCH_PPPOE = 6;
    public static final int MATCH_MOBILE_WILDCARD = 7; //6;
    public static final int MATCH_WIFI_WILDCARD = 8; //7;
    public static final int MATCH_BLUETOOTH = 9; //9;
