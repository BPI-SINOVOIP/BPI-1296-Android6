...
public class Camera {
    ...
    public class Parameters {
        ...
        private static final String KEY_VIDEO_FRAME_FORMAT = "video-frame-format";
        ...
        /**
         * Gets the supported video callback format.
         *
         * @return a list of Size object. This method will always return a list
         *         with at least one element.
         */
        public List<String> getSupportedVideoFormat() {
            String str = get(KEY_VIDEO_FRAME_FORMAT + SUPPORTED_VALUES_SUFFIX);
            return split(str);
        }
        /**
        ...
        @Deprecated
        public void setVideoFrameFormat(String format) {
            set(KEY_VIDEO_FRAME_FORMAT, format);
        }
