...
jstring getMimeTypeString(JNIEnv* env, SkImageDecoder::Format format) {
    static const struct {
        ...
        { SkImageDecoder::kTIFF_Format, "image/tiff" },
...
static jobject nativeDecodeFileDescriptor(JNIEnv* env, jobject clazz, jobject fileDescriptor,
	...
	*/
    ...
    jobject retObj = doDecode(env, fileStream, padding, bitmapFactoryOptions);
...
static jobject nativeDecodeAsset(JNIEnv* env, jobject clazz, jlong native_asset,
    ...
    options = env->NewGlobalRef(options);
    jobject retObj = doDecode(env, stream, padding, options);
    env->DeleteGlobalRef(options);
    return retObj;
}
...
static jobject nativeDecodeByteArray(JNIEnv* env, jobject, jbyteArray byteArray,
    ...
    options = env->NewGlobalRef(options);
    jobject retObj = doDecode(env, stream, NULL, options);
    env->DeleteGlobalRef(options);
    return retObj;
}
