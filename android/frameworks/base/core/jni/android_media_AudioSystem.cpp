...
// rtk begin
static jint
android_media_AudioSystem_setHDMIRXvolume(JNIEnv *env, jobject clazz, jint volume)
{
    return (jint) AudioSystem::setHDMIRXvolume((int) volume);
}
// rtk end
...
static JNINativeMethod gMethods[] = {
    ...
    // rtk begin
    {"setHDMIRXvolume",     "(I)I",     (void *)android_media_AudioSystem_setHDMIRXvolume},
    // rtk end
