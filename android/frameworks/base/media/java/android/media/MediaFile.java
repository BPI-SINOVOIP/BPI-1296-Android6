...
public class MediaFile {
    ...
    public static final int FILE_TYPE_MPG     = 203;
    public static final int FILE_TYPE_ISO     = 204;
    public static final int FILE_TYPE_AVS     = 205;
    public static final int FILE_TYPE_OGM     = 206;
    public static final int FILE_TYPE_SWF     = 207;
    public static final int FILE_TYPE_TRP     = 208;
    public static final int FILE_TYPE_XVID    = 209;
...
//        addFileType("SWF", FILE_TYPE_SWF, "application/x-shockwave-flash");
        ...
        addFileType("TIF", FILE_TYPE_TIFF, "image/tiff");
        //[RTK End]
