...
public class MediaInserter {
    ...
    private static int mBufferSizePerUri;
    ...
    public MediaInserter(IContentProvider provider, String packageName, int bufferSizePerUri, int maxbufferSizePerUri, int autoInc) {
        mProvider = provider;
        mPackageName = packageName;
        mBufferSizePerUri = bufferSizePerUri;
