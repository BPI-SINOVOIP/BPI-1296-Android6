...
public class MtpDatabase {
    ...
    public MtpDatabase(Context context, String volumeName, String storagePath,
        ...
        Log.d(TAG, "create volumeName: " + volumeName + " , storagePath: " + storagePath);
    ...
    private int beginSendObject(String path, int format, int parent,
        ...
        Log.d(TAG, "Send Object path: " + path + " , formate " + format);
    ...
    private Cursor createObjectQuery(int storageID, int format, int parent) throws RemoteException {
        ...
        Log.d(TAG, "object_query mPackageName " + mPackageName + " , mObjectsUri: " + mObjectsUri + " , whereArgs: " + Arrays.toString(whereArgs));
    ...
    private int[] getObjectList(int storageID, int format, int parent) {
        Cursor c = null;
        Log.d(TAG, "getObjectList storageID " + storageID + " , formate " + format + " , parent " + parent);
        try {
            ...
            Log.d(TAG, "getObjectList count " + count );
            if (count > 0) {
    ...
    private int getNumObjects(int storageID, int format, int parent) {
        Cursor c = null;
        Log.d(TAG, "getNumObjects storageID " + storageID + " , formate " + format + " , parent " + parent);
        try {
            c = createObjectQuery(storageID, format, parent);
            if (c != null) {
                Log.d(TAG, "getNumObjects count " + c.getCount());
                return c.getCount();
            }
        } catch (RemoteException e) {
