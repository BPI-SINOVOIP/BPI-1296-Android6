...
public class UsbDeviceManager {
    ...
    private final class UsbHandler extends Handler {
        ...
        public void updateState(String state) {
            ...
            Slog.d(TAG, "send message (" + state + ") , connected: " + connected + " configured: " + configured );
        ...
        private void setUsbDataUnlocked(boolean enable) {
            ...
            //It cause mtp_usb device re-open and wrong status of USB function. 
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_UPDATE_STATE:
                    ...
                    Slog.d(TAG, "msg: " + msg + " , MSG_UPDATE_STATE mConnected:" + mConnected + " , mConfigured: " + mConfigured );
                    if (!mConnected) {
