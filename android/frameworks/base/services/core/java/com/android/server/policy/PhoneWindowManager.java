...
//Obsolete, not use RTK CEC any more 
//import com.realtek.hardware.RtkCECManager;
...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    //private RtkCECManager mCECManager = null;
    ...
    public void setInitialDisplaySize(Display display, int width, int height, int density) {
        ...
        int forceHideNavigationBar = SystemProperties.getInt("rtk.screen.HideNavigationBar", -1);
        if (forceHideNavigationBar == 1)
        {
            mHasNavigationBar = false;
        }
        ...
        int forceOrient = SystemProperties.getInt("persist.rtk.forceOrientation", -1);
      if (forceOrient == -1)
      {
    ...
    public int interceptKeyBeforeQueueing(KeyEvent event, int policyFlags) {
        ...
        if(!down && interactive == true)
        {
            ...
            //Obsolete, not use RTK CEC any more. 
            //if ("true".equals(SystemProperties.get("ro.config.enablececservice")))
                //mCECManager.doOneTouchPlay(keyCode); //RTK CEC
            //else{
            //}
