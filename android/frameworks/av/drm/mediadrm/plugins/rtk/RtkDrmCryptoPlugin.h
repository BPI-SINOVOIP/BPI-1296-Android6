...
namespace android {
    ...
    class RtkDrmFactory : public DrmFactory {
    public:
        RtkDrmFactory() {}
        virtual ~RtkDrmFactory() {Rtk_DrmFactory_Finalize();}
    ...
    class RtkCryptoFactory : public CryptoFactory {
    public:
        RtkCryptoFactory() {}
        virtual ~RtkCryptoFactory() {}
    ...
    class RtkDrmPlugin : public DrmPlugin {
    public:
        RtkDrmPlugin() {}
        virtual ~RtkDrmPlugin() {}
    ...
    class RtkCryptoPlugin : public CryptoPlugin {

        virtual ~RtkCryptoPlugin(){Rtk_Plugin_Finalize();}
        ...
        ssize_t decrypt(bool secure,const void *srcPtr, void *dstPtr, size_t size);

        ssize_t encrypt(bool secure,const void *srcPtr, void *dstPtr, size_t size);
    private:
