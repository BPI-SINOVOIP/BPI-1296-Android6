...
public:
    ...
    void getSupportedVideoFormat(Vector<Size> &sizes) const;
    ...
    static const char KEY_SUPPORTED_VIDEO_FRAME_FORMAT[];
    ...
    static const char PIXEL_FORMAT_YVU420SP[]; // NV21
    static const char PIXEL_FORMAT_YUV420SP[]; // NV12
