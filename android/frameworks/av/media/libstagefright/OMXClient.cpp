...
void MuxOMX::setSideBand(
        node_id node, bool enableSideBand) {
    ALOGV("\033[0;33m !!!!! In %s:%d enableSideBand :%d !!!!!\033[m", __FUNCTION__, __LINE__, enableSideBand);
    getOMX(node)->setSideBand(node, enableSideBand);
}
//[ RTK end ]
