...
#endif /* end of DUMP_DECODE_FRAME */
    if (mSrcFormat == HAL_PIXEL_FORMAT_RTK_W16_H16_YCbCr_420_SP)
    {
        newSrcWidth     = ALIGN16(srcWidth);
        newSrcHeight    = ALIGN16(srcHeight);
    }
    else if (mSrcFormat == HAL_PIXEL_FORMAT_RTK_W32_H16_YCbCr_420_SP)
    {
        newSrcWidth     = ALIGN32(srcWidth);
        newSrcHeight    = ALIGN16(srcHeight);
    }
    else if (mSrcFormat == HAL_PIXEL_FORMAT_RTK_W16_H32_YCbCr_420_SP)
    {
        newSrcWidth     = ALIGN16(srcWidth);
        newSrcHeight    = ALIGN32(srcHeight);
    }
    else if (mSrcFormat == HAL_PIXEL_FORMAT_RTK_W32_H32_YCbCr_420_SP)
    {
        newSrcWidth     = ALIGN32(srcWidth);
        newSrcHeight    = ALIGN32(srcHeight);
    }
    else if (mSrcFormat == HAL_PIXEL_FORMAT_RTK_W16_H8_YCbCr_420_SP)
    {
        newSrcWidth     = ALIGN16(srcWidth);
        newSrcHeight    = ALIGN8(srcHeight);
    }
    else if (mSrcFormat == HAL_PIXEL_FORMAT_RTK_W16_H16_YCrCb_420_SP)
    {
        newSrcWidth     = ALIGN16(srcWidth);
        newSrcHeight    = ALIGN16(srcHeight);
    }
    else if (mSrcFormat == HAL_PIXEL_FORMAT_RTK_W32_H16_YCrCb_420_SP)
    {
        newSrcWidth     = ALIGN32(srcWidth);
        newSrcHeight    = ALIGN16(srcHeight);
    }
    else if (mSrcFormat == HAL_PIXEL_FORMAT_RTK_W16_H32_YCrCb_420_SP)
    {
        newSrcWidth     = ALIGN16(srcWidth);
        newSrcHeight    = ALIGN32(srcHeight);
    }
    else if (mSrcFormat == HAL_PIXEL_FORMAT_RTK_W32_H32_YCrCb_420_SP)
    {
        newSrcWidth     = ALIGN32(srcWidth);
        newSrcHeight    = ALIGN32(srcHeight);
    }
    else if (mSrcFormat == HAL_PIXEL_FORMAT_RTK_W16_H8_YCrCb_420_SP)
    {
        newSrcWidth     = ALIGN16(srcWidth);
        newSrcHeight    = ALIGN8(srcHeight);
    }
    else if (mSrcFormat == HAL_PIXEL_FORMAT_RTK_16_YCbCr_420_SP)
    {
        newSrcWidth = ALIGN16(srcWidth);
        newSrcHeight = ALIGN16(srcHeight);
    }
    else if (mSrcFormat == HAL_PIXEL_FORMAT_RTK_32_YCbCr_420_SP)
    {
        newSrcWidth = ALIGN32(srcWidth);
        newSrcHeight = ALIGN16(srcHeight);
    }
