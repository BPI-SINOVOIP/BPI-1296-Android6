...
MPEG4Writer::Track::Track(
    ...
    int enc = 0;
    mMeta->findInt32('enda', &enc);
    mIsEncrypted = (enc == 1) ? true : false;
    ALOGV("mIsEncrypted:%d", mIsEncrypted);
...
#else //20140530 charleslin - h264 encoder may output SPS/PPS before each I frame, just skip it
...
void MPEG4Writer::Track::writeEndaBox() {
    mOwner->beginBox("enda");
    mOwner->writeInt32(1);
    mOwner->endBox();  // enda
}
