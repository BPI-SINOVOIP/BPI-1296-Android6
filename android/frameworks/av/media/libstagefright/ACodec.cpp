        ...
        if (err == OK) {
            ...
            for (OMX_U32 i = 0; i < def.nBufferCountActual && err == OK; ++i) {
                ...
                if ((portIndex == kPortIndexInput && (mFlags & kFlagIsSecure))
                    ...
                    ALOGD("\033[0;33m ======== in %s:%d shareFd:%d ionFd:%d i:%d def.nBufferCountActual:%d err:%x ======\033[m", __FUNCTION__, __LINE__, shareFd, ionFd, (int)i, (int)def.nBufferCountActual, err);
...
bool ACodec::UninitializedState::onAllocateComponent(const sp<AMessage> &msg) {
    ...
    if (componentName.endsWith(".secure")) {
        if (mCodec->mCrypto)
        {
            ...
            ALOGD("\033[0;35m ######## In %s:%d Using normal playback mode ############ \033[m", __FUNCTION__, __LINE__);
    }
