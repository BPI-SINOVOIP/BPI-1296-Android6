...
struct MPEG2TSWriter::SourceInfo : public AHandler {
    ...
    SourceInfo(const sp<MediaSource> &source, bool transcodeFile, int32_t VideoFrameFps);
...
MPEG2TSWriter::SourceInfo::SourceInfo(const sp<MediaSource> &source, bool transcodeFile, int32_t VideoFrameFps)
    : mSource(source),
      mLooper(new ALooper),
      mAACBps(0),
      mEOSReceived(false),
