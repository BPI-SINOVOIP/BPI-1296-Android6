...
#ifdef RTK_PLATFORM
    void setStartPBDropFrame(int32_t dIsEnbDropDrame);
...
private:
    ...
    struct timeval s_systime;
    struct timeval e_systime;

    int64_t mVideoFirstMediaUs;
    bool mFirstVideoRenderFrame;
    bool mFirstAudioRenderFrame;
    bool mHLSSeekDoneFlg;
    bool mEnbSlowDelayFlg;
    bool mAudioEOS;
