...
bool ForceStop()
{
    char szForceStopProp[PROPERTY_VALUE_MAX ]={0};
    property_get("rtk.mediascanner.forcestopscan", szForceStopProp, "");
    if((strlen(szForceStopProp)>0) && (strcmp(szForceStopProp, "true")==0))
              return true;
    else return false;
}
...
MediaScanResult MediaScanner::processDirectory(
    ...
    if(ForceStop()==true) return MEDIA_SCAN_RESULT_ERROR;
