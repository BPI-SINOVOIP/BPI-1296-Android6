...
const char CameraParameters::KEY_SUPPORTED_VIDEO_FRAME_FORMAT[] = "video-frame-format-values";
...
void CameraParameters::getSupportedVideoFormat(Vector<Size> &sizes) const
{
    const char *videoFormatStr = get(KEY_SUPPORTED_VIDEO_FRAME_FORMAT);
    parseSizesList(videoFormatStr, sizes);
}
