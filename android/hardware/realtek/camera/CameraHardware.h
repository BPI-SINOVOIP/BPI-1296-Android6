...
private:
    ...
    String8 getSupportVideoFormatString();
    ...
    sp<CameraMediaCodec>    mDecode;
    int32_t                 mCodecFreeBuffers;
    int32_t                 mApkFreeBuffers;
#else
    sp<CameraDecode>        mDecode;
#endif /* end of USE_MEDIA_CODEC */
