...
extern "C" {
    ...
    void vdi_set_rtk_clk_rate(Uint32 coreIdx, Uint32 rate);
    unsigned int vdi_get_support_vtype(Uint32 coreIdx);
    unsigned int vdi_get_rtk_clk_select(Uint32 coreIdx);
    void vdi_set_rtk_clk_select(Uint32 coreIdx, Uint32 parent);
    void vdi_set_rtk_clk_setting(Uint32 coreIdx, Uint32 parent, Uint32 rate);
