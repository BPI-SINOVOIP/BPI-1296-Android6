...
public:
    ...
    struct private_rtk_data {
        ...
        unsigned int  sw_dei_key;
        unsigned int  sw_dei_response;
        unsigned int  reserve[64-39];
    };
    ...
    public:
        ...
        virtual void allocate(int w, int h, int format, int usage, buffer_handle_t *pBufferHandle, uint32_t *pPhyBufferHandle);
        virtual void freehandle(buffer_handle_t pBufferHandle);
        virtual void flush();
    ...
    virtual void allocate(Client * client, int w, int h, int format, int usage, buffer_handle_t *pBufferHandle, uint32_t *pPhyBufferHandle);
    virtual void freehandle(Client * client,buffer_handle_t pBufferHandle);
private:
