...
extern "C" {
    ...
    typedef enum { YUV444, YUV422, YUV224, YUV420, NV12, NV21, YUV400, YUYV, YVYU, UYVY, VYUY, YYY, RGB_PLANAR, RGB32, RGB24, RGB16 } yuv2rgb_color_format;
    typedef enum { ARGB4444, RGB565, ARGB8888 } rgb_color_format;
    void jpu_yuv2rgb(int width, int height, yuv2rgb_color_format format, unsigned char *src, int dest_width, int dest_height, rgb_color_format rgbFormat, unsigned char *rgba, int chroma_reverse);
