...
#define MAX_INPUT_BUFFER_SIZE            (192*1024)
...
int32_t ionAllocate(int ionfd, ion_user_handle_t *ionHandle, unsigned int *phyAddr, unsigned char *virtAddress, unsigned int size, uint32_t audioHwSync);
