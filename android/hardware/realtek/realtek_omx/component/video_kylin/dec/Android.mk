...
OMX_HEVC_10BIT_HDR_SUPPORT = true
# build video decoder
include $(CLEAR_VARS)
...
#ENABLE_SW_DEINTERLACE = true
ifeq ($(ENABLE_SW_DEINTERLACE), true)
LOCAL_CFLAGS += -fopenmp
LOCAL_LDFLAGS := -fopenmp
LOCAL_LDFLAGS += $(TOP)/device/realtek/proprietary/libs/libmad/libmads.a
LOCAL_LDFLAGS += $(TOP)/device/realtek/proprietary/libs/libmad/libgomp.a
LOCAL_LDFLAGS += $(TOP)/device/realtek/proprietary/libs/libmad/libgcc.a
LOCAL_CFLAGS += -DENABLE_SW_DEINTERLACED
endif
...
ifeq ($(OMX_HEVC_10BIT_HDR_SUPPORT), true)
...
ifeq ($(ENABLE_SW_DEINTERLACE), true)
LOCAL_C_INCLUDES += device/realtek/proprietary/libs/libmad
endif
